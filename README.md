...
Attachment names, descriptions, spoilers and reply context are preserved. Reply attribution names the original message's author beside a jump link when Discord can resolve them; unavailable replies retain the link. Missing permissions, failed copies and size limits leave the original intact. Polls, stickers, forwards, pinned messages and thread starters are skipped. A failed source deletion can leave both messages. Reply mode keeps the source and its attachments. Both modes suppress mention notifications.
