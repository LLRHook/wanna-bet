...
Attachment names, descriptions, spoilers and reply context are preserved. Reply attribution names the original message's author beside a jump link. Replies to Linky reposts name the person who shared that post, using saved ownership or the verified credit on an older repost. Unresolved replies retain the link. Missing permissions, failed copies and size limits leave the original intact. Polls, stickers, forwards, pinned messages and thread starters are skipped. A failed source deletion can leave both messages. Reply mode keeps the source and its attachments. Both modes suppress mention notifications.
